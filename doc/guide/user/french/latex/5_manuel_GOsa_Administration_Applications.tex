...
\hline 
Nom de l'application\textcolor{red}{{*}}&
obligatoire. Indiquez le nom de l'application.\tabularnewline
\hline 
Exécuter\textcolor{red}{{*}}&
...
\hline 
Description&
Description de l'application\tabularnewline
\hline 
Base&
Choisissez dans la liste déroulante le département associé à l'application.\tabularnewline
\hline 
Icône&
...
\hline 
Variable&
Nom de la variable\tabularnewline
\hline 
Valeur par défaut&
Valeurs par defaut asscociées à la variable\tabularnewline
\hline
\end{tabular}
