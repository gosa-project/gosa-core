<div class="acl-content-wrapper">
    ...
    <div class="acl-role-head card-content-scroll">
        ...
        {$aclList} {render acl=$gosaAclTemplateACL}
        <button class="btn-small" type='submit' name='new_acl'>{t}New ACL{/t}</button> {/render}
    </div>
    ...
    <div class="card-action">
        ...
        <button class="btn-small gonicus-color" type='submit' name='submit_new_acl'>{msgPool type=applyButton}</button> {/render}
