...
<div class="card-action">
  <button class="btn-small gonicus-color" type="submit" name="add_users_finish">{msgPool type=okButton}</button>
  <button class="btn-small gonicus-color" type="submit" name="add_users_cancel">{msgPool type=cancelButton}</button>
</div>
