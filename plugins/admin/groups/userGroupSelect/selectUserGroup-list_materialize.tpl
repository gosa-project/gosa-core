...
<button class="btn-small gonicus-color" type="submit" name="userGroupSelect_save">{msgPool type=okButton}</button>
<button class="btn-small gonicus-color" type="submit" name="userGroupSelect_cancel">{msgPool type=cancelButton}</button>
