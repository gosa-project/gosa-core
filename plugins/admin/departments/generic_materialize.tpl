...
<div class="organization card-content-scroll">
  ...
  <div class="row content">
    <div class="col s6">
      ...
      {render acl=$descriptionACL}
        <div class="input-field">
          <textarea class="materialize-textarea" id='description' name='description' title="{t}Descriptive text for department{/t}">{$description}</textarea>
