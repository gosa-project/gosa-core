    ...
    <tr>
        <td style="width:50%">
            ...
            <table summary="{t}Properties{/t}">
                <tr>
                    <td>
                        <LABEL for="o">{t}Name of organization{/t}</LABEL>{$must}</td>
                    <td>
                        {render acl=$oACL}
                        <input type='text' id="o" name="o" size=25 maxlength=60 value="{$o}" title="{t}Name of organization to create{/t}"> {/render}
                    </td>
                </tr>
                <tr>
                    <td>
