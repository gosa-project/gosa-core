        ...
        <div class="card z-depth-0">
            <div class="card-content">
                ...
                <div class="input-field">
                    ...
                    <input type='text' id="facsimileTelephoneNumber" name="facsimileTelephoneNumber" size=25
                        maxlength=60 value="{$facsimileTelephoneNumber}"
                        title="{t}Base facsimile telephone number of this subtree{/t}">
                    {/render}
