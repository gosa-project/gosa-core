...
<div class="card-action">
  <button class="btn-small gonicus-color" type=submit name="objectSelect_save">{msgPool type=okButton}</button>
  <button class="btn-small gonicus-color" type=submit name="objectSelect_cancel">{msgPool type=cancelButton}</button>
</div>
