           ...
           {html_options options=$secondaryGroups selected=$primaryGroup}
			...
			<table style='width:100%;'>
	  			<tr>
					...
					<td>
						<input id="uidNumber" name="uidNumber" size=12 maxlength=9 {$forceMode} value="{$uidNumber}">
					</td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
					...
					<td>
						<input id="gidNumber" name="gidNumber" size=12 maxlength=9 {$forceMode} value="{$gidNumber}">
					</td>
				</tr>
			</table>
		</td>
