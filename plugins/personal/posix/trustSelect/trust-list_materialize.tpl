...
{$LIST}
<div class="row">
  <button class="btn-small gonicus-color" type='submit' name='add_ws_finish'>{msgPool type=addButton}</button>
  <button class="btn-small gonicus-color" type='submit' name='add_ws_cancel'>{msgPool type=cancelButton}</button>
</div>
