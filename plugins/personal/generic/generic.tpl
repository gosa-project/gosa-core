        ...
        <tr>
          <td style='width:147px; height:200px; background-color:gray; vertical-align: middle;'>
            ...
            <img src="getbin.php?rand={$rand}" alt=''
              style='max-width:147px; max-height: 200px; vertical-align: middle;'>
            {/if}
          </td>
        </tr>
        <tr>
      ...
      <table summary="{t}Postal address{/t}">
        <tr>
          ...
          <td>
            ...
            <textarea cols='200' id="homePostalAddress" name="homePostalAddress" rows="3"
              style="width:100%">{$homePostalAddress}</textarea>
            {/render}
          </td>
        </tr>
        <tr>
      ...
      <table summary="{t}Organizational information{/t} - {t}part{/t} 3">
        ...
        <tr>
          ...
          <td>
            ...
            <textarea cols="200" id="postalAddress" name="postalAddress" rows=3
              style="width:100%">{$postalAddress}</textarea>
            {/render}
          </td>
        </tr>
      </table>
      ...
      <table summary="{t}Organizational information{/t} - {t}part{/t} 1">
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" id="gouvernmentOrganizationalUnitDescription"
              name="gouvernmentOrganizationalUnitDescription" maxlength=60
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" id="gouvernmentOrganizationalUnitSubjectArea"
              name="gouvernmentOrganizationalUnitSubjectArea" maxlength=60
      ...
      <table summary="{t}Organizational information{/t} - {t}part{/t} 2">
        <tr>
          ...
          <td>
            ...
            <input type="text" id="gouvernmentOrganizationalPersonLocality"
              name="gouvernmentOrganizationalPersonLocality" maxlength=60
    ...
    <td>
      <table summary="{t}Organizational information{/t} - {t}part{/t} 3">
        ...
        <tr>
          ...
          <td>
            {render acl=$ivbbLastDeliveryCollectiveACL checkbox=$multiple_support
            checked=$use_ivbbLastDeliveryCollective}
