            ...
            <table summary="{t}The users picture{/t}">
                <tr>
                    <td style='width:147px; height:200px; background-color:gray; vertical-align: middle;'>
                        ...
                        <img src="plugins/users/images/default.jpg" alt=''> {else}
                        <img src="getbin.php?rand={$rand}" alt='' style='max-width:147px; max-height: 200px; vertical-align: middle;'> {/if}
                    </td>
                </tr>
                <tr>
                    <td>
                        {render acl=$userPictureACL checkbox=$multiple_support checked=$use_edit_picture}
                        <button type="submit" name="edit_picture">{t}Change picture{/t}...</button> {/render}
                    </td>
                </tr>
            </table>
            <!-- /The users picture settings container -->
        ...
        <td style='width:45%'>
            ...
            <table summary="{t}Account settings{/t}">
                <tr>
                    ...
                    <td>
                        {if $multiple_support}
                        <input type="text" id="sn" name="dummy2" maxlength=60 value="{t}Multiple edit{/t}" disabled> {else} {render acl=$snACL}
                        <input type="text" id="sn" name="sn" maxlength=60 value="{$sn}"> {/render} {/if}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {if $multiple_support}
                        <input type="text" id="givenName" name="dummy3" maxlength=60 value="{t}Multiple edit{/t}" disabled> {else} {render acl=$givenNameACL}
                        <input type="text" id="givenName" name="givenName" maxlength=60 value="{$givenName}"> {/render} {/if}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {if !$multiple_support} {render acl=$uidACL}
                        <input type="text" id="uid" name="uid" maxlength=60 value="{$uid}"> {/render} {else}
                        <input type="text" id="uid" name="dummy1" maxlength=60 value="{t}Multiple edit{/t}" disabled> {/if}
                    </td>
                </tr>
                ...
                <table summary="{t}Account settings{/t}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="personalTitle" name="personalTitle" maxlength=60 value="{$personalTitle}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="text" id="academicTitle" name="academicTitle" maxlength=60 value="{$academicTitle}"> {/render}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="dateOfBirth" name="dateOfBirth" class="date" value="{$dateOfBirth}"> {if $dateOfBirthACL|regex_replace:"/[cdmr]/":"" == "w"}
            ...
            <table summary="{t}Postal address{/t}">
                <tr>
                    ...
                    <td>
                        ...
                        <textarea cols='200' id="homePostalAddress" name="homePostalAddress" rows="3" style="width:100%">{$homePostalAddress}</textarea> {/render}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="homePhone" name="homePhone" maxlength=60 value="{$homePhone}"> {/render}
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" id="labeledURI" name="labeledURI" maxlength=60 value="{$labeledURI}"> {/render}
                    </td>
                </tr>
                <tr>
              ...
              {/foreach}
            </select> {if $pw_configurable eq "true"} &nbsp; <button id="edit_pw_method" type="submit" name="edit_pw_method">{t}Configure{/t}...</button> {/if} {/render}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button id="edit_cert" type="submit" name="edit_cert">{t}Edit certificates{/t}...</button> {/render}
                    </td>
                </tr>
                {/if}
                ...
                <tr>
                    <td colspan="2"><label for="res">{t}Restrict login to{/t}</label> {if !$multiple_support} {render acl=$gosaLoginRestrictionACL} {$gosaLoginRestrictionWidget} {/render} {render acl=$gosaLoginRestrictionACL}
                        <input type="text" id="res" name="res" maxlength=33 value="{t}IP or network{/t}" onFocus='document.getElementById("res").value=""'> {/render} {render acl=$gosaLoginRestrictionACL}
                        <button id="add_res" type="submit" name="add_res">{t}Add{/t}</button> {/render} {else}
                        <input type='checkbox' name='use_gosaLoginRestriction' {if $use_gosaLoginRestriction} checked {/if} onClick='document.mainform.submit();'> {if !$use_gosaLoginRestriction} {render acl=$gosaLoginRestriction_ONLY_R_ACL} {$gosaLoginRestrictionWidget}
                        {/render} {else} {render acl=$gosaLoginRestrictionACL} {$gosaLoginRestrictionWidget} {/render} {render acl=$gosaLoginRestrictionACL}
                        <input type="text" id="res" name="res" maxlength=33 value="{t}IP or network{/t}" onFocus='document.getElementById("res").value=""'> {/render} {render acl=$gosaLoginRestrictionACL}
                        <button id="add_res" type="submit" name="add_res">{t}Add{/t}</button> {/render} {/if} {/if}
                    </td>
                </tr>
            </table>
        </td>
                ...
                <table summary="{t}Organizational information{/t} - {t}part{/t} 1">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="o" name="o" maxlength=60 value="{$o}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="ou" name="ou" maxlength=60 value="{$ou}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="departmentNumber" name="departmentNumber" maxlength=60 value="{$departmentNumber}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="employeeNumber" name="employeeNumber" maxlength=60 value="{$employeeNumber}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="employeeType" name="employeeType" maxlength=60 value="{$employeeType}"> {/render}
                        </td>
                    </tr>
                    {if !$multiple_support}
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' name='manager_name' id='manager_name' value='{$manager_name}' disabled title='{$manager}' style='width:120px;'> {/render} {image path="images/lists/edit.png" action="editManager" acl=$managerACL} {if $manager!=""}
                            {image path="images/info_small.png" title="{$manager}" acl=$managerACL} {image path="images/lists/trash.png" action="removeManager" acl=$managerACL} {/if}
                        </td>
                    </tr>
                    {else}
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' name='manager_name' id='manager_name' value='{$manager_name}' disabled title='{$manager}'> {if $use_manager} {image path="images/lists/edit.png" action="editManager"} {if $manager!=""} {image path="images/info_small.png"
                            title="{$manager}"} {image path="images/lists/trash.png" action="removeManager"} {/if} {/if}
                        </td>
                    </tr>
                ...
                <table summary="{t}Organizational information{/t} - {t}part{/t} 2">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="roomNumber" name="roomNumber" maxlength=60 value="{$roomNumber}"> {/render}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="telephoneNumber" name="telephoneNumber" maxlength=60 value="{$telephoneNumber}"> {/render}
                        </td>
                    </tr>
                    {/if}
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="mobile" name="mobile" maxlength=60 value="{$mobile}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="pager" name="pager" maxlength=60 value="{$pager}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="facsimileTelephoneNumber" name="facsimileTelephoneNumber" maxlength=60 value="{$facsimileTelephoneNumber}"> {/render}
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table summary="{t}Organizational information{/t} - {t}part{/t} 3">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="l" name="l" maxlength=60 value="{$l}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="st" name="st" maxlength=60 value="{$st}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea cols="200" id="postalAddress" name="postalAddress" rows=3 style="width:100%">{$postalAddress}</textarea> {/render}
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table summary="{t}Organizational information{/t} - {t}part{/t} 1">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="vocation" name="vocation" maxlength=60 value="{$vocation}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="gouvernmentOrganizationalUnitDescription" name="gouvernmentOrganizationalUnitDescription" maxlength=60 value="{$gouvernmentOrganizationalUnitDescription}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="gouvernmentOrganizationalUnitSubjectArea" name="gouvernmentOrganizationalUnitSubjectArea" maxlength=60 value="{$gouvernmentOrganizationalUnitSubjectArea}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="functionalTitle" id="functionalTitle" maxlength=60 value="{$functionalTitle}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="role" name="role" maxlength=60 value="{$role}"> {/render}
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table summary="{t}Organizational information{/t} - {t}part{/t} 2">
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="gouvernmentOrganizationalPersonLocality" name="gouvernmentOrganizationalPersonLocality" maxlength=60 value="{$gouvernmentOrganizationalPersonLocality}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="gouvernmentOrganizationalUnit" name="gouvernmentOrganizationalUnit" maxlength=60 value="{$gouvernmentOrganizationalUnit}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="street" id="street" maxlength=60 value="{$street}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="postalCode" id="postalCode" maxlength=60 value="{$postalCode}"> {/render}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" id="houseIdentifier" name="houseIdentifier" maxlength=60 value="{$houseIdentifier}"> {/render}
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table summary="{t}Organizational information{/t} - {t}part{/t} 3">
                    ...
                    <tr>
                        <td><label for="telephoneNumber">{t}Phone{/t}</label></td>
                        <td>
                            {render acl=$telephoneNumberACL checkbox=$multiple_support checked=$use_telephoneNumber} {if $has_phoneaccount ne "true"}
                            <input type="text" id="telephoneNumber" name="telephoneNumber" maxlength=60 value="{$telephoneNumber}"> {else}
                            <i>{t}Please use the phone tab{/t}</i> {/if} {/render}
                        </td>
                    </tr>
                    <tr>
                        <td><label for="facsimileTelephoneNumber">{t}Fax{/t}</label></td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ivbbLastDeliveryCollective" maxlength=60 id="ivbbLastDeliveryCollective" value="{$ivbbLastDeliveryCollective}"> {/render}
                        </td>
                    </tr>
                    <tr>
