...
<div class="row content">
    ...
    <div class="col s6 xl5">
        ...
        <div class="input-field">
            {if $multiple_support}
            <input type="text" name="dummy2" id="sn" value="{t}Multiple edit{/t}" disabled> {else} {render acl=$snACL}
            <input type="text" name="sn" id="sn" value="{$sn}"> {/render} {/if}
            <label for="sn">{t}Last name{/t}{$must}</label>
        </div>

        <div class="input-field">
            {if $multiple_support}
            <input type="text" name="dummy3" id="givenName" value="{t}Multiple edit{/t}" disabled> {else} {render acl=$givenNameACL}
            <input type="text" name="givenName" id="givenName" value="{$givenName}"> {/render} {/if}
            <label for="givenName">{t}First name{/t}{$must}</label>
        </div>

        <div class="input-field">
            {if $multiple_support}
            <input type="text" name="dummy1" id="uid" value="{t}Multiple edit{/t}" disabled> {else} {render acl=$uidACL}
            <input type="text" name="uid" id="uid" value="{$uid}"> {/render} {/if}
        ...
        <div class="input-field">
            {render acl=$uidACL}
            <input type="text" name="sn" id="sn" value="{$sn}"> {/render}
        ...
        <div class="input-field">
            ...
            <input class="datepicker" type="text" id="dateOfBirth" name="dateOfBirth" value="{$dateOfBirth}"> {/render}
    ...
    <div class="col s6 xl5">
        ...
        <div class="input-field certificate">
            ...
            <button class="btn-small" id="edit_cert" type="submit" name="edit_cert">{t}Edit certificates{/t}...</button> {/render}
        </div>

        {/if} {if !$multiple_support}

        <div class="input-field acl-member-wrapper">
            <label>{t}Restrict login to{/t}</label> {render acl=$gosaLoginRestrictionACL} {$gosaLoginRestrictionWidget} {/render}
        </div>

        <div class="input-field add">
            {render acl=$gosaLoginRestrictionACL}
            <input type="text" id="res" name="res" maxlength=33 onFocus='document.getElementById("res").value=""'> {/render} {render acl=$gosaLoginRestrictionACL}
            <button class="btn btn-small" id="add_res" type="submit" name="add_res">{t}Add{/t}</button> {/render}
        ...
        {if !$use_gosaLoginRestriction} {render acl=$gosaLoginRestriction_ONLY_R_ACL} {$gosaLoginRestrictionWidget} {/render} {else} {render acl=$gosaLoginRestrictionACL} {$gosaLoginRestrictionWidget} {/render}
        ...
        <div class="input-field">
            ...
            <button class="btn-small gonicus-color" id="add_res" type="submit" name="add_res">{t}Add{/t}</button> {/render} {/if}
...
<div class="row">
    ...
    <div class="col s4">
        ...
        <div class="input-field">
            ...
            <input type="text" id="ou" name="ou" maxlength=60 value="{$o}"> {/render}
    ...
    <div class="col s4">
        ...
        <div class="input-field manager">
            ...
            <div class="icons">
                ...
                <div class="icon">
                    {render acl=$managerACL} {image path="<i class='material-icons input-icons tooltipped' data-postion='bottom' data-tooltip='{$manager}'>info</i>" title="{$manager}"} {/render}
                </div>
                {else}
                <div class="icon">
                ...
                <div class="icon">
                    {render acl=$managerACL} {image path="<i class='material-icons md-disabled context'>info</i>"} {/render}
                </div>
                {/if}
            </div>
        </div>
