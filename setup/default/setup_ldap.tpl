<div class="content-wrapper card-content-scroll">
    ...
    <div class="connection-wrapper">
        ...
        <div class="row">
            ...
            <div class="col s12 xl6 connection-setting">
                <div class="input-field">
                    <input id="connection-uri" type='text' name='connection' maxlength='80' size='40'
                        value='{$connection}'>
            ...
            <div class="col s12 xl6 connection-setting">
                ...
                <button class="btn-flat" type="submit" name="reload" title="{t}Reload{/t}"><i
    ...
    <div class="authentication-wrapper">
        ...
        <div class="row">
            <div class="col s12 xl6 connection-setting">
                <div class="input-field">
                    <input id="administrator-dn" type='text' name='admin_given' maxlength='160' size='40'
                        value='{$admin_given}'>
                ...
                <button class="btn-flat" type="submit" name="resolve_user" title="{t}Select user{/t}"><i
            ...
            <div class="col s12 xl6 connection-setting">
                <label class="checkbox">
                    <p>
                        <input onClick='document.mainform.submit();' {if $append_base_to_admin_dn} checked {/if}
